...
public class BubbleColumnUpParticle extends TextureSheetParticle {
    private BubbleColumnUpParticle(final ClientLevel dwl, final double double2, final double double3, final double double4, final double double5, final double double6, final double double7) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(final SimpleParticleType hi, final ClientLevel dwl, final double double3, final double double4, final double double5, final double double6, final double double7, final double double8) {
            final BubbleColumnUpParticle dxb16 = new BubbleColumnUpParticle(dwl, double3, double4, double5, double6, double7, double8, null);
            dxb16.pickSprite(this.sprite);
            return dxb16;
        }
    }
}
