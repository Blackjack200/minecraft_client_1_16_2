...
public class ItemModelGenerators {
    ...
    public ItemModelGenerators(final BiConsumer<ResourceLocation, Supplier<JsonElement>> biConsumer) {
        this.output = biConsumer;
    }
    
    private void generateFlatItem(final Item blu, final ModelTemplate ix) {
        ix.create(ModelLocationUtils.getModelLocation(blu), TextureMapping.layer0(blu), this.output);
    }
    
    private void generateFlatItem(final Item blu, final String string, final ModelTemplate ix) {
        ix.create(ModelLocationUtils.getModelLocation(blu, string), TextureMapping.layer0(TextureMapping.getItemTexture(blu, string)), this.output);
    }
    
    private void generateFlatItem(final Item blu1, final Item blu2, final ModelTemplate ix) {
        ix.create(ModelLocationUtils.getModelLocation(blu1), TextureMapping.layer0(blu2), this.output);
    }
    ...
    public void run() {
        ...
        for (int integer2 = 1; integer2 < 64; ++integer2) {
            this.generateFlatItem(Items.CLOCK, String.format("_%02d", new Object[] { integer2 }), ModelTemplates.FLAT_ITEM);
        }
        ...
        for (int integer2 = 0; integer2 < 32; ++integer2) {
            if (integer2 != 16) {
                this.generateFlatItem(Items.COMPASS, String.format("_%02d", new Object[] { integer2 }), ModelTemplates.FLAT_ITEM);
            }
        }
