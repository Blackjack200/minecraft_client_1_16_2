...
public class BlockTagsProvider extends TagsProvider<Block> {
    public BlockTagsProvider(final DataGenerator hl) {
        super(hl, Registry.BLOCK);
    }
    ...
    protected Path getPath(final ResourceLocation vk) {
        return this.generator.getOutputFolder().resolve("data/" + vk.getNamespace() + "/tags/blocks/" + vk.getPath() + ".json");
    }
