...
public class ItemTagsProvider extends TagsProvider<Item> {
    ...
    public ItemTagsProvider(final DataGenerator hl, final BlockTagsProvider js) {
        super(hl, Registry.ITEM);
        this.blockTags = (Function<Tag.Named<Block>, Tag.Builder>)js::getOrCreateRawBuilder;
    }
    ...
    protected void copy(final Tag.Named<Block> e1, final Tag.Named<Item> e2) {
        final Tag.Builder a4 = this.getOrCreateRawBuilder(e2);
        final Tag.Builder a5 = (Tag.Builder)this.blockTags.apply(e1);
        a5.getEntries().forEach(a4::add);
    }
    
    @Override
    protected Path getPath(final ResourceLocation vk) {
        return this.generator.getOutputFolder().resolve("data/" + vk.getNamespace() + "/tags/items/" + vk.getPath() + ".json");
    }
