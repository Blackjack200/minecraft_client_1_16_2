...
public class Stats {
    ...
    private static ResourceLocation makeCustomStat(final String string, final StatFormatter adw) {
        final ResourceLocation vk3 = new ResourceLocation(string);
        Registry.<ResourceLocation>register(Registry.CUSTOM_STAT, string, vk3);
        Stats.CUSTOM.get(vk3, adw);
        return vk3;
    }
    
    private static <T> StatType<T> makeRegistryStatType(final String string, final Registry<T> gm) {
        return Registry.<StatType<T>>register(Registry.STAT_TYPE, string, new StatType<T>(gm));
    }
