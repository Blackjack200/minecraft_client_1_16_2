...
public class ItemIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        final Type<Either<Integer, Pair<String, String>>> type2 = (Type<Either<Integer, Pair<String, String>>>)DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), (Type)NamespacedSchema.namespacedString()));
        final Type<Pair<String, String>> type3 = (Type<Pair<String, String>>)DSL.named(References.ITEM_NAME.typeName(), (Type)NamespacedSchema.namespacedString());
