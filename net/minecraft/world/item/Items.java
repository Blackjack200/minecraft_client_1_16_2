...
public class Items {
    ...
    static {
        ...
        SOUL_TORCH = registerBlock(new StandingAndWallBlockItem(Blocks.SOUL_TORCH, Blocks.SOUL_WALL_TORCH, new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
        ...
        CRIMSON_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.CRIMSON_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        WARPED_DOOR = registerBlock(new DoubleHighBlockItem(Blocks.WARPED_DOOR, new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
        ...
        JIGSAW = registerBlock(new GameMasterBlockItem(Blocks.JIGSAW, new Item.Properties().rarity(Rarity.EPIC)));
        ...
        WOODEN_HOE = registerItem("wooden_hoe", (Item)new HoeItem(Tiers.WOOD, 0, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        ...
        STONE_HOE = registerItem("stone_hoe", (Item)new HoeItem(Tiers.STONE, -1, -2.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        ...
        GOLDEN_HOE = registerItem("golden_hoe", (Item)new HoeItem(Tiers.GOLD, 0, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        ...
        IRON_HOE = registerItem("iron_hoe", (Item)new HoeItem(Tiers.IRON, -2, -1.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        ...
        DIAMOND_HOE = registerItem("diamond_hoe", (Item)new HoeItem(Tiers.DIAMOND, -3, 0.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
        NETHERITE_SWORD = registerItem("netherite_sword", (Item)new SwordItem(Tiers.NETHERITE, 3, -2.4f, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
        NETHERITE_SHOVEL = registerItem("netherite_shovel", (Item)new ShovelItem(Tiers.NETHERITE, 1.5f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
        NETHERITE_PICKAXE = registerItem("netherite_pickaxe", (Item)new PickaxeItem(Tiers.NETHERITE, 1, -2.8f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
        NETHERITE_AXE = registerItem("netherite_axe", (Item)new AxeItem(Tiers.NETHERITE, 5.0f, -3.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
        NETHERITE_HOE = registerItem("netherite_hoe", (Item)new HoeItem(Tiers.NETHERITE, -4, 0.0f, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
        ...
        NETHERITE_HELMET = registerItem("netherite_helmet", (Item)new ArmorItem(ArmorMaterials.NETHERITE, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
        NETHERITE_CHESTPLATE = registerItem("netherite_chestplate", (Item)new ArmorItem(ArmorMaterials.NETHERITE, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
        NETHERITE_LEGGINGS = registerItem("netherite_leggings", (Item)new ArmorItem(ArmorMaterials.NETHERITE, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
        NETHERITE_BOOTS = registerItem("netherite_boots", (Item)new ArmorItem(ArmorMaterials.NETHERITE, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
        ...
        CRIMSON_SIGN = registerItem("crimson_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.CRIMSON_SIGN, Blocks.CRIMSON_WALL_SIGN));
        WARPED_SIGN = registerItem("warped_sign", (Item)new SignItem(new Item.Properties().stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.WARPED_SIGN, Blocks.WARPED_WALL_SIGN));
        ...
        BEE_SPAWN_EGG = registerItem("bee_spawn_egg", (Item)new SpawnEggItem(EntityType.BEE, 15582019, 4400155, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        HOGLIN_SPAWN_EGG = registerItem("hoglin_spawn_egg", (Item)new SpawnEggItem(EntityType.HOGLIN, 13004373, 6251620, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", (Item)new SpawnEggItem(EntityType.PIGLIN, 10051392, 16380836, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        PIGLIN_BRUTE_SPAWN_EGG = registerItem("piglin_brute_spawn_egg", (Item)new SpawnEggItem(EntityType.PIGLIN_BRUTE, 5843472, 16380836, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        STRIDER_SPAWN_EGG = registerItem("strider_spawn_egg", (Item)new SpawnEggItem(EntityType.STRIDER, 10236982, 5065037, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        ZOGLIN_SPAWN_EGG = registerItem("zoglin_spawn_egg", (Item)new SpawnEggItem(EntityType.ZOGLIN, 13004373, 15132390, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem("zombified_piglin_spawn_egg", (Item)new SpawnEggItem(EntityType.ZOMBIFIED_PIGLIN, 15373203, 5009705, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
        ...
        CARROT_ON_A_STICK = registerItem("carrot_on_a_stick", (Item)new FoodOnAStickItem<>(new Item.Properties().durability(25).tab(CreativeModeTab.TAB_TRANSPORTATION), EntityType.PIG, 7));
        WARPED_FUNGUS_ON_A_STICK = registerItem("warped_fungus_on_a_stick", (Item)new FoodOnAStickItem<>(new Item.Properties().durability(100).tab(CreativeModeTab.TAB_TRANSPORTATION), EntityType.STRIDER, 1));
        ...
        MUSIC_DISC_PIGSTEP = registerItem("music_disc_pigstep", (Item)new RecordItem(13, SoundEvents.MUSIC_DISC_PIGSTEP, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(Rarity.RARE)));
        ...
        PIGLIN_BANNER_PATTERN = registerItem("piglin_banner_pattern", (Item)new BannerPatternItem(BannerPattern.PIGLIN, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
        ...
        HONEY_BOTTLE = registerItem("honey_bottle", (Item)new HoneyBottleItem(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE).food(Foods.HONEY_BOTTLE).tab(CreativeModeTab.TAB_FOOD).stacksTo(16)));
