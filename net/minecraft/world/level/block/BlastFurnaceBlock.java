...
public class BlastFurnaceBlock extends AbstractFurnaceBlock {
    ...
    public void animateTick(final BlockState cee, final Level bru, final BlockPos fx, final Random random) {
        if (!cee.<Boolean>getValue((Property<Boolean>)BlastFurnaceBlock.LIT)) {
            return;
        }
        ...
        if (random.nextDouble() < 0.1) {
            bru.playLocalSound(double6, double7, double8, SoundEvents.BLASTFURNACE_FIRE_CRACKLE, SoundSource.BLOCKS, 1.0f, 1.0f, false);
        }
        final Direction gc12 = cee.<Direction>getValue((Property<Direction>)BlastFurnaceBlock.FACING);
