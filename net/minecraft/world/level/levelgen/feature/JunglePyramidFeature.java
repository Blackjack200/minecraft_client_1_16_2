...
public class JunglePyramidFeature extends StructureFeature<NoneFeatureConfiguration> {
    public JunglePyramidFeature(final Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public static class FeatureStart extends StructureStart<NoneFeatureConfiguration> {
        ...
        public void generatePieces(final RegistryAccess gn, final ChunkGenerator cfv, final StructureManager cst, final int integer4, final int integer5, final Biome bss, final NoneFeatureConfiguration cme) {
            final JunglePyramidPiece crc9 = new JunglePyramidPiece(this.random, integer4 * 16, integer5 * 16);
            this.pieces.add(crc9);
