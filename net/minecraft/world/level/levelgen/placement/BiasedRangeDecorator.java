...
public class BiasedRangeDecorator extends SimpleFeatureDecorator<RangeDecoratorConfiguration> {
    public BiasedRangeDecorator(final Codec<RangeDecoratorConfiguration> codec) {
        super(codec);
    }
    ...
    public Stream<BlockPos> place(final Random random, final RangeDecoratorConfiguration cml, final BlockPos fx) {
        ...
        final int integer7 = random.nextInt(random.nextInt(cml.maximum - cml.topOffset) + cml.bottomOffset);
