...
public class VeryBiasedRangeDecorator extends SimpleFeatureDecorator<RangeDecoratorConfiguration> {
    public VeryBiasedRangeDecorator(final Codec<RangeDecoratorConfiguration> codec) {
        super(codec);
    }
    ...
    public Stream<BlockPos> place(final Random random, final RangeDecoratorConfiguration cml, final BlockPos fx) {
        ...
        final int integer7 = random.nextInt(random.nextInt(random.nextInt(cml.maximum - cml.topOffset) + cml.bottomOffset) + cml.bottomOffset);
