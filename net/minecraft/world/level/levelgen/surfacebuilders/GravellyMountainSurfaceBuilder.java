...
public class GravellyMountainSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    public GravellyMountainSurfaceBuilder(final Codec<SurfaceBuilderBaseConfiguration> codec) {
        super(codec);
    }
    ...
    public void apply(final Random random, final ChunkAccess cft, final Biome bss, final int integer4, final int integer5, final int integer6, final double double7, final BlockState cee8, final BlockState cee9, final int integer10, final long long11, final SurfaceBuilderBaseConfiguration ctr) {
        if (double7 < -1.0 || double7 > 2.0) {
            SurfaceBuilder.DEFAULT.apply(random, cft, bss, integer4, integer5, integer6, double7, cee8, cee9, integer10, long11, SurfaceBuilder.CONFIG_GRAVEL);
        }
        else if (double7 > 1.0) {
            SurfaceBuilder.DEFAULT.apply(random, cft, bss, integer4, integer5, integer6, double7, cee8, cee9, integer10, long11, SurfaceBuilder.CONFIG_STONE);
        }
        else {
