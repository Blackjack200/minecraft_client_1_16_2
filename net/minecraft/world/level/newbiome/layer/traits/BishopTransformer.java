...
public interface BishopTransformer extends AreaTransformer1, DimensionOffset1Transformer {
    ...
    default int applyPixel(final BigContext<?> cvg, final Area cvc, final int integer3, final int integer4) {
        return this.apply(cvg, cvc.get(this.getParentX(integer3 + 0), this.getParentY(integer4 + 2)), cvc.get(this.getParentX(integer3 + 2), this.getParentY(integer4 + 2)), cvc.get(this.getParentX(integer3 + 2), this.getParentY(integer4 + 0)), cvc.get(this.getParentX(integer3 + 0), this.getParentY(integer4 + 0)), cvc.get(this.getParentX(integer3 + 1), this.getParentY(integer4 + 1)));
    }
}
