...
public class BuiltInLootTables {
    ...
    private static ResourceLocation register(final ResourceLocation vk) {
        if (BuiltInLootTables.LOCATIONS.add(vk)) {
            return vk;
        }
        throw new IllegalArgumentException(new StringBuilder().append(vk).append(" is already a registered built-in loot table").toString());
    }
